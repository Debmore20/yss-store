const Tools = () => {
    return (
        <ul className=" hidden md:block sm:space-y-1 sm:py-2 sm:px-2 sm:ml-4 sm:fixed sm:top-32 sm:rounded-lg sm:bg-gray-900 sm:bg-opacity-20 text-white">
            <li>
                <button className="sm:px-3 sm:py-2 hover:bg-stone-300 hover:text-slate-900 hover:rounded-lg">
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path id="search-icon" d="M15 15L21 21" stroke="#323232" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <li>
                <button className="sm:px-3 sm:py-2 hover:bg-stone-300 hover:text-slate-900 hover:rounded-lg">
                    <svg id="cart-icon" width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
